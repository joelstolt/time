...
export const metadata = {
  title: "Fönsterputs butik Stockholm | Skyltfönster från 250 kr",
  alternates: { canonical: "/fonsterputs-butik" },
  description:
...
export default function FonsterputsButik() {
  const schemas = [
    { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Fönsterputs butik", item: "https://www.timeoutservice.se/fonsterputs-butik" },
    ]},
