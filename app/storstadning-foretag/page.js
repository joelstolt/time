...
export const metadata = {
  title: "Storstädning företag Stockholm | Kontor & Lokaler",
  alternates: { canonical: "/storstadning-foretag" },
  description:
...
export default function StorstadningForetag() {
  const schemas = [
    { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Storstädning företag", item: "https://www.timeoutservice.se/storstadning-foretag" },
    ]},
