...
export const metadata = {
  title: "Fönsterputs företag Stockholm | Kontor & Fastigheter",
  alternates: { canonical: "/fonsterputs-foretag" },
  description:
...
export default function FonsterputsForetag() {
  const schemas = [
    { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Fönsterputs företag", item: "https://www.timeoutservice.se/fonsterputs-foretag" },
    ]},
