...
export const metadata = {
  title: "Mattvätt företag Stockholm | Kontor & BRF",
  alternates: { canonical: "/mattvatt-foretag" },
...
export default function MattvattForetag() {
  const schemas = [
    { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Mattvätt företag", item: "https://www.timeoutservice.se/mattvatt-foretag" },
    ]},
