...
export const metadata = {
  title: "Miljöpolicy - Hållbar städning i Stockholm",
  alternates: { canonical: "/miljopolicy" },
...
export default function Miljopolicy() {
  const schemas = [
    { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Miljöpolicy", item: "https://www.timeoutservice.se/miljopolicy" },
    ]},
  ];
